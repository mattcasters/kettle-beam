...
public class BeamInputStepHandler implements BeamStepHandler {
  ...
  public BeamInputStepHandler( IMetaStore metaStore, TransMeta transMeta, List<String> stepPluginClasses, List<String> xpPluginClasses ) {
